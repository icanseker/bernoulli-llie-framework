...
where:
  img_d  = double(img_low)            — precomputed in run_bernoulli.m (once)
  I_edge = conv(img_d, H_edge)        — precomputed in run_bernoulli.m (once)
...
```
algorithms/
├── run_bernoulli.m        Proposed method wrapper
