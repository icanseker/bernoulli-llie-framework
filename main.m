%% main.m — Low-Light Image Enhancement: Bernoulli Polynomial Method
%
%  Paper: "A Computationally Optimized and Dynamically Refined Framework for
%          Structure-Preserving Low-Light Image Enhancement via Bernoulli
...
%    3. Runs the proposed Bernoulli method (if I_mean < threshold) and all
...
%  processed by the proposed Bernoulli method and all comparison algorithms.
%
...
% Phase 2 Nelder-Mead tolerances are both resolved inside run_bernoulli.m.
...
%
% See run_bernoulli.m for exact parameter values and timing estimates.
...
%  ═══════════════════════════════════════════════════════════════════════════
algorithms = {
    'Bernoulli', @run_bernoulli, 'polynomial';   % Proposed: Bernoulli coefficients + 8-dir convolution
...
fprintf('=== Bernoulli Low-Light Enhancement ===\n\n');
...
for i = 1:num_images
    ...
    if skip_polynomial
        fprintf('  I_mean=%.1f >= %d → Bernoulli will be SKIPPED for this image\n', ...
...
%  (default 64 = 128/2). Low-light is defined as I_mean < 64. The proposed Bernoulli
